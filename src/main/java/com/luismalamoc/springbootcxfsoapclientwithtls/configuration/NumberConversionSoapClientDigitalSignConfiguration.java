...
public class NumberConversionSoapClientDigitalSignConfiguration {
    ...
    private final Logger LOG = LoggerFactory.getLogger(NumberConversionSoapClientDigitalSignConfiguration.class);

    /**
     * If I want to set Digital Sign I need this configuration
     * @return
     */
    //@Bean
    //@Qualifier("numberConversionSoapDigitalSignConfig")
